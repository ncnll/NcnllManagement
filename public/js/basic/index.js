	...
	$("#logout").click(function() {
		$.messager.confirm('退出提示', '确定退出系统？', function(r) {
			if (r) {
				...
				$.messager.show({
                	title: '提示',
                    msg: "<div style='text-align:center;margin-top:10px;'>退出成功!</div>",
                    style:{
                		right:'',
				...
				setTimeout(function(){
                	$.post("/vpi/logout", function(result){
						window.location.href = "/backend/loginIndex";
					});
                },1000);
			}
		});
        ...
        success: function(resultString){
            ...
            if (!result.success){
                ...
                $.messager.show({
                	...
                	title: '提示<span style="color:red;">!</span>',
                    msg: "<div style='text-align:center;margin-top:10px;'>-----"+result.message+"</div>",
                    style:{
                		right:'',
                		top:document.body.scrollTop+document.documentElement.scrollTop,
                		bottom:''
